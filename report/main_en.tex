...
\renewcommand\labelitemi{--}
    ...
    \item \Large \textbf{TRAINING PROGRAM: Standard Program}
\end{itemize}
\vspace{0.7cm}
\begin{itemize}
\renewcommand\labelitemi{--}
    ...
    \\ \Large \textbf{FULL NAME: Bùi Quang Anh Kiệt} \textbf{STUDENT ID: 2311748}
\end{itemize}
\vspace{0.5cm}
\begin{center}
...
\newpage
\section{Summary}
\subsection{Self-evaluation: about the skills/ knowledge learned after the internship?}
\input{generated/en/6_Self_evaluation}
\subsection{Feedback about the company, about the internship program}
