...
\renewcommand\labelitemi{--}
    ...
    \item \Large \textbf{CHƯƠNG TRÌNH ĐÀO TẠO: Chương trình đào tạo tiêu chuẩn}
\end{itemize}
\vspace{0.7cm}
\begin{itemize}
\renewcommand\labelitemi{--}
    ...
    \\ \Large \textbf{Phạm Công Thái}
    \item \Large \textbf{SINH VIÊN THỰC HIỆN (SVTH):}
    \\ \Large \textbf{HỌ VÀ TÊN: Bùi Quang Anh Kiệt} \textbf{MSSV: 2311748}
\end{itemize}
\vspace{0.5cm}
\begin{center}
...
\newpage
\section{Tổng kết quá trình thực tập}
% \subsection{Tự đánh giá về kĩ năng/ kiến thức đã học được sau quá trình thực tập}
% \input{generated/vi/6_Self_evaluation}
% \subsection{Nhận xét cá nhân về doanh nghiệp, về chương trình thực tập}
